...
**Status:** open, 2026-08-28. This is a **data** task, not a code task, and it is
the only thing standing between the project and an automatic fix for the pale-
background defect. Owner agreed to shoot these.
