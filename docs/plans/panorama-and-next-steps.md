...
**MEASURED 2026-09-24 — the continuity test is REFUSED, and the count above
does not reproduce.** A pre-registered census (RESULTS 2026-09-24; vertical
stacks only) finds 52 stacked pairs, of which 21 are one picture cut in two;
the method behind 35 + 10 was never committed. The statistic catches 18
