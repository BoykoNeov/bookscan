...
def test_the_pdf_origin_reaches_split_json_on_both_paths():
    """``layout_origin`` tells an imported page from a phone page (Stage 03 skips
    flattening on it): it says where the pixels came from — not ``layout_source``,
    which says who chose the layout and
